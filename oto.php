        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Danh sách ô tô</h1>
                    <div class="card mb-4">
                        ...
                        <?php if (isset($_GET['msg'])){
                            ...
                            <?php } else { ?>
                                ...
                                <strong>Xe đang có trong hợp đồng, không thể xóa</strong>
                            </div>
                            <?php }  ?> 
                            <?php }  ?>   
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                <?php 
                                    $query = "SELECT a.*,b.ten as 'chinhanh' FROM oto as a,chinhanh as b WHERE a.chinhanh_id = b.id ORDER BY a.id DESC";
                                    ...
                                    <tr>
                                        ...
                                        <td> <img height="200px" width="300px" src="<?php echo $arUser["anh"] ?>"></td>
                                        <td><?php echo $arUser["gia"] ?></td>
                                        <td><?php echo $arUser["chinhanh"] ?></td>
                                        <td>
