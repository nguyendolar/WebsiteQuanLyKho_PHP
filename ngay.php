                        ...
                        <div class="card-body mt-4">
                            <table id="datatablesSimple">
                                ...
                                if(isset($_POST['thongke'])){
                                    $ngay = $_POST['ngay'];
                                    $sum = 0;
                                    $query = "SELECT a.*,b.ten as 'loaihopdong',c.hoten as 'khachhang', d.hoten as 'nhanvien', e.ten as 'oto' FROM hopdong as a,loaihopdong as b, khachhang as c, nhanvien as d, oto as e WHERE a.loaihopdong_id = b.id AND a.khachhang_id = c.id AND a.nhanvien_id = d.id AND a.oto_id = e.id AND DATE(ngaytao) = '{$ngay}' ORDER BY id DESC";
                                    ...
                                    <!-- Modal Update-->
                                    <?php $sum = $sum + $arUser["tongtien"];} echo "<h4>Danh sách doanh thu ngày ".$ngay."_____________________Tổng doanh thu : ".$sum." VND</h4>";}  ?>
